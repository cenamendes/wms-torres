...
<x-tenant-layout title="Detalhe da Saída" :themeAction="$themeAction" :status="$status" :message="$message">
    {{-- Content --}}
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="user-preview">
                            <i class="fa-solid fa-user"></i>{{$userPreview->user_name}}
                        </div>
                    </div>
                    <div class="card-body">
                        @livewire('tenant.saidas.saidas-detail', ['document' => $document, $encomenda])
                    </div>
                </div>
            </div>
        </div>
