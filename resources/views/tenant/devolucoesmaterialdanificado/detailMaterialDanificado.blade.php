...
<x-tenant-layout title="Detalhe da Encomenda Danificada" :themeAction="$themeAction" :status="$status" :message="$message">
    {{-- Content --}}
        ...
        <div class="row">
            <div class="col-xl-9 col-xs-6">
                <div class="page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Devoluções Material Danificado</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @livewire('tenant.devolucoes-material-danificado.show-devolucoes-material-detail', ['encomenda' => $encomenda])
                    </div>
                </div>
            </div>
        </div>
