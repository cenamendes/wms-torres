                    ...
                    <div class="col-xl-9 col-xs-6">
                        <div class="page-titles">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><a href="javascript:void(0)">Picking</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-xs-6 col-md-9">
                                    <h4 class="card-title">{{ __('Listagem Picking') }}</h4>
                                </div>
                                {{--@php
                                    ...
                                    <table class="table-striped-fornecedor" style="width:100%;table-layout:fixed;">
                                        <thead>
                                            <tr style="text-align:center;">
                                                ...
                                                <th class="titulo-th" style="padding-bottom: 10px;">Locais Stock</th>
                                                <th class="titulo-th" style="padding-bottom: 10px;">Estava em</th>
                                                <th class="titulo-th" style="padding-bottom: 10px;">QTD Separada</th>
                                                <th class="titulo-th" style="padding-bottom: 10px;">Data de Picking
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @php $index = 0 @endphp
                                            @foreach ($analises_picking as $analises)
                                                <tr
                                                    style="border:1px #0d0d0d7a solid; text-align:center; cursor:context-menu; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F0F0F0' }}">
                                                    <td style="padding-bottom:30px;">
                                                        <br><span class="paragrafo-td">{{ $analises->document }}</span>
                                                    </td>
                                                    <td><span class="paragrafo-td">{{ $analises->referencia }}</span>
                                                    </td>
                                                    <td><span
                                                            class="paragrafo-td">{{ $analises->locais_stock }}</span>
                                                    </td>
                                                    <td><span class="paragrafo-td">{{ $analises->estado }}</span>
                                                    </td>
                                                    <td><span
                                                            class="paragrafo-td">{{ $analises->qtd_separada }}</span>
                                                    </td>
                                                    <td><span
