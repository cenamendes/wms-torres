                ...
                <div class="row">
                    <div class="col-xl-9 col-xs-6">
                        <div class="page-titles">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Devoluções Clientes</a></li>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="col-xs-6 col-md-9">
                                    <h4 class="card-title">{{ __('Devoluções Clientes') }}</h4>
                                </div>
                                {{--@php
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($encomendas as $impr)
                                                <tr style="border:1px #0d0d0d7a solid; text-align:center; cursor: pointer; background-color: {{ $index % 2 == 0 ? '#FFFFFF' : '#F0F0F0' }}"
                                                    onclick="window.location='{{ route('tenant.devolucoesclientes.devolucoesclientesdetail', $impr->id) }}';">
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                            ...
                                                            wire:click="abrirPopUpInfo('{{ $impr->name }}')"
                                                            onclick="event.stopPropagation()">
                                                            <i class="fa fa-info"
                                                                style="padding: 1px; font-size: 20px; color: #ffffff"></i>
                                                        </button>
                                                        <a href="{{ route('tenant.devolucoesclientes.devolucoesclientesdetail', $impr->id) }}"
