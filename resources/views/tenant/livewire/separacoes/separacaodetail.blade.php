                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12" style="padding-left:0px;padding-right:0px;">
                                <div class="row" style="justify-content:end;">
                                        ...
                                        <button type="button" id="cancelarStock" wire:click="cancelarStock({{$orderNumber}})" class="btn-sm btn btn-danger"><i class="fa fa-ban"></i> Cancelar</button>
                           
                                        <button type="button" id="terminarStock" wire:click="terminarStock({{$orderNumber}})" class="btn-sm btn btn-success"><i class="fa fa-floppy-disk"></i> Terminar</button>
    ...
    <table class="table-striped" style="width:100%;table-layout:fixed;">
        <thead>
            <tr style="text-align:center;">
                ...
                <th style="padding-bottom: 10px;">QTD a separar</th>
            </tr>
        </thead>
        <tbody>
            @php
            ...
            @foreach ($encomendaDetail as $i => $impr)
                   ...
                   {{-- @php
                       ...
                       $movimentos = \App\Models\Tenant\MovimentosStock::where('tipo','Saida')->get();
                   ...
                   @endphp --}}
                        ...
                        <tr style="text-align:center;background: {{ $impr->color }};color:black;font-weight:bolder;">
                            ...
                            <td style="padding-bottom:30px;"><br><span style="padding-right: 5px;padding-left: 5px;">{{ $impr->quantity }} </span></td>
                        </tr>
