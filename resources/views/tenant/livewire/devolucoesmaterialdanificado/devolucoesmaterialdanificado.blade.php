            ...
            <div class="row">
                <div class="col-xl-9 col-xs-6">
                    <div class="page-titles">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Devoluções Material Danificado</a>
                            </li>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="col-xs-6 col-md-9">
                                <h4 class="card-title">{{ __('Devoluções Material Danificado') }}</h4>
                            </div>
                            {{--@php
                                ...
                                <table class="table-striped-fornecedor" style="width:100%;table-layout:fixed;">
                                    <thead>
                                        <tr style="text-align:center;">
                                            ...
                                            <th class="titulo-th" style="padding-bottom: 10px;">Nome do Fornecedor
                                            </th>
                                    ...
                                    <tbody>
                                        @foreach ($encomendas as $impr)
                                            <tr style="border:1px #0d0d0d7a solid; text-align:center; cursor: pointer;"
                                                onclick="window.location='{{ route('tenant.devolucoesmaterialdanificado.devolucoesmaterialdanificadodetail', $impr->id) }}';">
                                                <td style="padding-bottom:30px;">
                                                    <br><span
                                                        class="paragrafo-td">{{ $impr->numero_encomenda }}</span>
                                                </td>
                                                <td><span class="paragrafo-td">{{ $impr->nome_fornecedor }}</span>
                                                </td>
                                                <td><span class="paragrafo-td">{{ $impr->zone }}</span>
                                                </td>
                                                <td><span
                                                        class="paragrafo-td">{{ date('Y-m-d', strtotime($impr->data_documento)) }}</span>
                                                </td>
                                                <td>
                                                    <!--<a wire:click="sendBarcode({{ $impr->id }})" class="btn btn-primary shadow sharp mr-1" onclick="event.stopPropagation()">
                                                    <i class="fa fa-edit" style="padding:3px;"></i>
                                                </a>-->
                                                    <a href="{{ route('tenant.devolucoesmaterialdanificado.devolucoesmaterialdanificadodetail', $impr->id) }}"
