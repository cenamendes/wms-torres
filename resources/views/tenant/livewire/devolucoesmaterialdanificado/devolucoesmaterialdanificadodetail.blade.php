<div>
    ...
    <div class="table-responsive" wire:key="tenantcustomersshow">
        ...
        @foreach ($devolucoesmaterialdanificadodetail as $i => $impr)
            <tr style="text-align:center; background-color: {{ $i % 2 == 0 ? '#FFFFFF' : '#F0F0F0' }};">
                ...
                <td style="padding-bottom:25px; padding-right: 5px;"><br><span class="paragrafo-td"
                        style="padding-right: 5px;padding-left: 5px;">@php
                            $qtdmovstock = \App\Models\Tenant\MovimentosDevolucoesMaterial::where(
                                'numero_encomenda',
                                $encomenda,
                            )
                ...
                <td style=" align-items:center; justify-content: space-around;">
                    <div class="itens-2">
                        ...
                        <a style="margin-left: 20px"
                            wire:click="detalhesimpressao({{ json_encode($impr->id) }}, {{ json_encode($impr->referense) }}, {{ json_encode($impr->quantity) }}, {{ json_encode($impr->design) }}, {{ json_encode($impr->barcode) }})"
    ...
    {{-- </div> --}}
    {{ $devolucoesmaterialdanificadodetail->links() }}
</div>
</div>
