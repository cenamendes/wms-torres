                ...
                <div class="accordion__body--text">
                    <div class="col-12" style="margin-bottom:0;padding-left:0px;">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label>{{ __('Exit location') }}</label>
                                    <input type="text" id="saidaProd" class="form-control" 
                                        readonly>
                                </div>
                            </div>
                        </div>
        ...
        <div class="table-responsive-reference">
            <table class="table-striped-reference" style="width:100%;table-layout:fixed;">
                ...
                <tbody>
                    ...
                    @foreach ($saidaDetail as $i => $impr)
                        <tr style="text-align:center; background-color: {{ $i % 2 == 0 ? '#FFFFFF' : '#F0F0F0' }};">
                            <td style="padding-bottom:25px; padding-right: 5px;"><br><span
                            ...
                            <td style="padding-bottom:25px; padding-right: 5px;"><br><span
                                    class="paragrafo-td">{{ $impr->design }}</span></td>
                            <td style="padding-bottom:25px; padding-right: 5px;"><br><span
                                    class="paragrafo-td">{{ $impr->barcode }}</span></td>
                            <td style="padding-bottom:25px; padding-right: 5px;"><br><span
                                    class="paragrafo-td">@php
                                        $qtdmovstock = \App\Models\Tenant\MovimentosSaidas::where(
                                            'numero_encomenda',
                                            $encomenda,
                                        )
                            ...
                            <td style="padding-bottom:25px; padding-right: 5px;"><br><span
                                    class="paragrafo-td">{{ $impr->quantity }} </span></td>
                            {{-- <td style=" align-items:center; justify-content: space-around;">
                                <span style="padding-right: 20px;">
                                    <input type="checkbox" class="form-check-input imprimir-checkbox"
                                        ...
                                        wire:click="selecionarCheck('{{ $impr->id }}', '{{ $impr->referense }}', {{ $impr->design }})"
                                        style="transform: scale(1.7); margin-top:0.7rem; "></span>
                                <a wire:click="detalhesimpressao({{ json_encode($impr->id) }}, {{ json_encode($impr->referense) }}, {{ json_encode($impr->quantity) }}, {{ json_encode($impr->design) }}, {{ json_encode($impr->barcode) }})"
