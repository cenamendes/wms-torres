        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <label>Referência / Código de Barras da Localização</label>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Novo Código de Barras da Localização</label>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xs-12" style="padding-left:0px;padding-right:0px;">
                <div class="row" style="justify-content:end;">
                    ...
                    <button type="button" id="guardaStock" wire:click="guardaStock" class="btn-sm btn btn-primary"><i class="fa fa-save"></i> Atualizar</button>
