       ...
       <div id="accordion-one" class="accordion accordion-primary">
        <div class="accordion__item">
            <div class="accordion__header rounded-lg show" data-toggle="collapse" data-target="#default_collapseOne" aria-expanded="true">
                <span class="accordion__header--text">Transferência para Devolução</span>
                ...
                <div class="accordion__body--text">
                    <div class="col-12" style="margin-bottom:25px;padding-left:0px;">
                        <div class="row">
                            ...
                            <input type="hidden" id="transferir" class="form-control" wire:model.defer="transferir" value="3">
                            {{-- <div class="col-12">
                                <div class="form-group">
