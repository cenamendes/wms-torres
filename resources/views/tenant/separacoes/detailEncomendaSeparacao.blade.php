        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @livewire('tenant.separacoes.show-separacoes-detail', ["encomenda" => trim($encomenda)])
                    </div>
                </div>
            </div>
        </div>
    ...
    window.addEventListener('terminarStock',function(e){
        ...
        swal.fire({
            ...
            onOpen: function() {
                ...
                jQuery("body").on("click","#btnLoc", function(){
                    Livewire.emit('removeDosTemporariosSeparacao',jQuery(this).attr("data-mov"));
                });
        ...
        .then((result) => {
            if(result.value) {
                ...
                Livewire.emit('EnviarMovimentosPrincipalSeparacao',e.detail.orderNumber);
