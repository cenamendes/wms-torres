            ...
            <div class="collapse navbar-collapse justify-content-between">
                <div class="header-left">
                    <div class="dashboard_bar">
                        @yield('title', $page_title ?? __('Dashboard'))
                    </div>
                </div>
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="{{ route('tenant.profile.index') }}" class="dropdown-item ai-icon">
...
<script>
    ...
    var pusher = new Pusher('6040892f34869e3f2edd', {
        cluster: 'eu',
    });
    
    var channel = pusher.subscribe('chat');
    channel.bind('App\\Events\\ChatMessage', function(data) {
        Livewire.emit("realTimeUpdate");
