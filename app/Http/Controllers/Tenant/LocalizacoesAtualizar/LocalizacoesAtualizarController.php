...
namespace App\Http\Controllers\Tenant\LocalizacoesAtualizar;
...
class LocalizacoesAtualizarController extends Controller
{
    ...
    {
        return view('tenant.localizacoesatualizar.index', [
