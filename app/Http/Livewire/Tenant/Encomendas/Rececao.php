...
class Rececao extends Component
{
    ...
    protected $listeners = ["ReceiveImage" => "ReceiveImage", "encChange" => "encChange"];
    ...
    public function ReceiveImage($imageReceived)
    {
        ...
        foreach($imageReceived as $count => $img)
        {
        /*****PARTE DO SCAN ********/
        ...
        if (preg_match('/^data:image\/(\w+);base64,/', $img["src"])) {
            $data = substr($img["src"], strpos($img["src"], ',') + 1);
        ...
        $arrayImagens[$count] = $imagem_link;
       ...
       /********** OCR MINDEE **************/    
        ...
        {
            //FICHEIRO DA BRVR
            $response = '{"api_request": {"error": {}, "resources": ["document"], "status": "success", "status_code": 201, "url": "https://api.mindee.net/v1/products/mindee/invoices/v4/predict"}, "document": {"id": "1e5aaa6b-7746-4ebf-8d2c-14cd545a4f19", "inference": {"extras": {}, "finished_at": "2023-11-08T09:27:19.405971", "is_rotation_applied": true, "pages": [{"extras": {}, "id": 0, "orientation": {"value": 0}, "prediction": {"customer_address": {"confidence": 0.47, "polygon": [[0.476, 0.227], [0.63, 0.227], [0.63, 0.273], [0.476, 0.273]], "value": "Rua do Comercio No 49 Sao Romao 6270-303 Seia"}, "customer_company_registrations": [], "customer_name": {"confidence": 0.74, "polygon": [[0.476, 0.206], [0.647, 0.206], [0.647, 0.219], [0.476, 0.219]], "raw_value": "Paulo Ricardo Duarte Bras", "value": "PAULO RICARDO DUARTE BRAS"}, "date": {"confidence": 0.52, "polygon": [[0.302, 0.348], [0.421, 0.348], [0.421, 0.363], [0.302, 0.363]], "value": "2018-12-17"}, "document_type": {"value": "INVOICE"}, "due_date": {"confidence": 0.0, "polygon": [], "value": null}, "invoice_number": {"confidence": 0.99, "polygon": [[0.835, 0.064], [0.945, 0.064], [0.945, 0.081], [0.835, 0.081]], "value": "200800383"}, "line_items": [{"confidence": 0.9, "description": "PORTATIL TOSHIBA SATELLITE A300 1M1 CORE2DUO P8400 4GB 250GB 15.4\" WXGA VP S/n: Y8583070Q", "polygon": [[0.072, 0.46], [0.929, 0.46], [0.929, 0.498], [0.072, 0.498]], "product_code": "P00: 1", "quantity": 1.0, "tax_amount": null, "tax_rate": 20.0, "total_amount": 666.67, "unit_price": 666.67}], "locale": {"confidence": 0.79, "currency": "EUR", "language": "pt"}, "orientation": {"confidence": 0.99, "degrees": 0}, "reference_numbers": [{"confidence": 0.35, "polygon": [[0.072, 0.463], [0.095, 0.463], [0.095, 0.474], [0.072, 0.474]], "value": "P00:"}], "supplier_address": {"confidence": 0.45, "polygon": [[0.122, 0.268], [0.25, 0.268], [0.25, 0.29], [0.122, 0.29]], "value": "Rua de Regufe, n. o 33 4480 Vila do Conde"}, "supplier_company_registrations": [{"confidence": 0.99, "polygon": [[0.208, 0.248], [0.288, 0.248], [0.288, 0.26], [0.208, 0.26]], "type": "SIREN", "value": "252620240"}, {"confidence": 0.99, "polygon": [[0.208, 0.248], [0.288, 0.248], [0.288, 0.26], [0.208, 0.26]], "type": "VAT NUMBER", "value": "FR23252620240"}], "supplier_name": {"confidence": 0.02, "polygon": [[0.073, 0.066], [0.406, 0.066], [0.406, 0.155], [0.073, 0.155]], "raw_value": "BR VR IDENTIFICA\u00c7AO INFORMATICA E SERVI\u00c7OS,LDA", "value": "BR VR IDENTIFICA\u00c7AO INFORMATICA E SERVI\u00c7OS,LDA"}, "supplier_payment_details": [], "taxes": [{"confidence": 0.98, "polygon": [[0.196, 0.808], [0.375, 0.808], [0.375, 0.822], [0.196, 0.822]], "rate": 20.0, "value": 133.33}], "total_amount": {"confidence": 0.99, "polygon": [[0.816, 0.917], [0.901, 0.917], [0.901, 0.935], [0.816, 0.935]], "value": 800.0}, "total_net": {"confidence": 0.99, "polygon": [[0.843, 0.84], [0.912, 0.84], [0.912, 0.858], [0.843, 0.858]], "value": 666.67}}}], "prediction": {"customer_address": {"confidence": 0.47, "page_id": 0, "polygon": [[0.476, 0.227], [0.63, 0.227], [0.63, 0.273], [0.476, 0.273]], "value": "Rua do Comercio No 49 Sao Romao 6270-303 Seia"}, "customer_company_registrations": [], "customer_name": {"confidence": 0.74, "page_id": 0, "polygon": [[0.476, 0.206], [0.647, 0.206], [0.647, 0.219], [0.476, 0.219]], "raw_value": "Paulo Ricardo Duarte Bras", "value": "PAULO RICARDO DUARTE BRAS"}, "date": {"confidence": 0.52, "page_id": 0, "polygon": [[0.302, 0.348], [0.421, 0.348], [0.421, 0.363], [0.302, 0.363]], "value": "2018-12-17"}, "document_type": {"value": "INVOICE"}, "due_date": {"confidence": 0.0, "page_id": null, "polygon": [], "value": null}, "invoice_number": {"confidence": 0.99, "page_id": 0, "polygon": [[0.835, 0.064], [0.945, 0.064], [0.945, 0.081], [0.835, 0.081]], "value": "200800383"}, "line_items": [{"confidence": 0.9, "description": "PORTATIL TOSHIBA SATELLITE A300 1M1 CORE2DUO P8400 4GB 250GB 15.4\" WXGA VP S/n: Y8583070Q", "page_id": 0, "polygon": [[0.072, 0.46], [0.929, 0.46], [0.929, 0.498], [0.072, 0.498]], "product_code": "P00: 1", "quantity": 1.0, "tax_amount": null, "tax_rate": 20.0, "total_amount": 666.67, "unit_price": 666.67}], "locale": {"confidence": 0.79, "currency": "EUR", "language": "pt"}, "reference_numbers": [{"confidence": 0.35, "page_id": 0, "polygon": [[0.072, 0.463], [0.095, 0.463], [0.095, 0.474], [0.072, 0.474]], "value": "P00:"}], "supplier_address": {"confidence": 0.45, "page_id": 0, "polygon": [[0.122, 0.268], [0.25, 0.268], [0.25, 0.29], [0.122, 0.29]], "value": "Rua de Regufe, n. o 33 4480 Vila do Conde"}, "supplier_company_registrations": [{"confidence": 0.99, "page_id": 0, "polygon": [[0.208, 0.248], [0.288, 0.248], [0.288, 0.26], [0.208, 0.26]], "type": "SIREN", "value": "252620240"}, {"confidence": 0.99, "page_id": 0, "polygon": [[0.208, 0.248], [0.288, 0.248], [0.288, 0.26], [0.208, 0.26]], "type": "VAT NUMBER", "value": "FR23252620240"}], "supplier_name": {"confidence": 0.02, "page_id": 0, "polygon": [[0.073, 0.066], [0.406, 0.066], [0.406, 0.155], [0.073, 0.155]], "raw_value": "BR VR IDENTIFICA\u00c7AO INFORMATICA E SERVI\u00c7OS,LDA", "value": "BR VR IDENTIFICA\u00c7AO INFORMATICA E SERVI\u00c7OS,LDA"}, "supplier_payment_details": [], "taxes": [{"confidence": 0.98, "page_id": 0, "polygon": [[0.196, 0.808], [0.375, 0.808], [0.375, 0.822], [0.196, 0.822]], "rate": 20.0, "value": 133.33}], "total_amount": {"confidence": 0.99, "page_id": 0, "polygon": [[0.816, 0.917], [0.901, 0.917], [0.901, 0.935], [0.816, 0.935]], "value": 800.0}, "total_net": {"confidence": 0.99, "page_id": 0, "polygon": [[0.843, 0.84], [0.912, 0.84], [0.912, 0.858], [0.843, 0.858]], "value": 666.67}}, "processing_time": 2.624, "product": {"features": ["locale", "invoice_number", "reference_numbers", "date", "due_date", "total_net", "total_amount", "taxes", "supplier_payment_details", "supplier_name", "supplier_company_registrations", "supplier_address", "customer_name", "customer_company_registrations", "customer_address", "document_type", "orientation", "line_items"], "name": "mindee/invoices", "type": "standard", "version": "4.3"}, "started_at": "2023-11-08T09:27:16.781699"}, "n_pages": 1, "name": "7470461835.png"}}';
        }
        else
        {
            //FICHEIRO DA BOXPT
       ...
       /********************************** */
        ...
        foreach($response_decoded->document->inference->pages as $i => $line)
        {
            ...
            {              
                ...
                $tmp = (array) $cod_barras_random;
                if(empty($tmp))
                {
                    $cod_barras_random = $this->encomendaRepository->getCodBarras("WMS");
                }

                
                $arrayLines[$countLines] = [
            ...
            if(!isset($line->prediction->supplier_company_registrations[0]->value))
            {
                $nif = "";
            }
            else
            {
                $nif = $line->prediction->supplier_company_registrations[0]->value;
            }
            ...
            $array_encomenda = [
                ...
                "imagem" => json_encode($arrayImagens),
    ...
    public function sendBarcode($id)
    {
        ...
        $message .= '<div>
                        <label>Número de encomenda</label>
                        <input type="text" id="encNumber" class="form-control">
                    </div>';

        $this->dispatchBrowserEvent('SendBarCode', ['title' => "Encomenda", "id" => $id, 'message' => $message, 'status' => 'info']);
    }

    public function encChange($enc,$id)
    {
        Encomendas::where('id',$id)->update(["numero_encomenda" => $enc]);

        $this->dispatchBrowserEvent('swalFire', ['title' => "Encomenda", 'message' => "Número de encomenda com sucesso", 'status' => 'success']);
    }
